...
const services = [
  ...
  { title: "Meta OglaÅ¡avanje", href: "/usluge/meta-oglasavanje", desc: "Facebook & Instagram" },
...
export default function ServicesPage() {
  return (
    <Section>
      ...
      <p className="text-gray-600 text-center mb-12">Specijalizovane strategije za digitalno oglaÅ¡avanje</p>
