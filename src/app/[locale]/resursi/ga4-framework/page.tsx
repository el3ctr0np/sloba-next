...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildMetadata({
    title: isEn
      ? "GA4 Audience Framework for Repeat-Purchase Ecommerce"
      : "GA4 Audience Framework za eCommerce sa Ponovljenom Kupovinom",
    description: isEn
      ? "Twenty five GA4 audience lists across six layers, as markdown files you drop into Claude or ChatGPT so it builds them with you, plus a PDF. Lifecycle."
      : "Dvadeset pet GA4 audience lista u šest stubova, kao markdown fajlovi koje ubaciš u Claude ili ChatGPT pa ti ih gradi, plus PDF. Lifecycle, vrednost.",
    locale,
