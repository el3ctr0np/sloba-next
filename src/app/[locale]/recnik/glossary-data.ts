...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    definitionSr: "CTR je jedan od najvažnijih signala kvaliteta u Google Ads-u kroz Expected CTR komponentu Quality Score-a (Google ne objavljuje tačnu težinu). Visok CTR = viši Quality Score = niži CPC za istu poziciju. Ali pažnja: visok CTR nije uvek cilj. Visok konvertujući CTR jeste. Veoma širok CTR sa lošom konverzijom može značiti da oglasi privlače pogrešnu publiku.",
    definitionEn: "CTR is one of the most important quality signals in Google Ads through the Expected CTR component of Quality Score (Google doesn't publish the exact weighting). Higher CTR = higher Quality Score = lower CPC for the same position. Caveat: high CTR isn't always the goal. High-converting CTR is. A very broad CTR with poor conversion may mean ads are attracting the wrong audience.",
    ...
    benchmarks: [
      ...
      { label: "Shopping (post-launch SR)", range: "0.7-1.5%" },
    ],
  ...
  },
  {
    ...
    category: "tracking",
    shortDefinitionSr: "Attribution Model je pravilo za dodeljivanje zasluge za konverziju kroz više dodirnih tačaka u customer journey-u. Google Ads danas koristi Data-Driven Attribution kao default; stariji modeli (Linear, Position-Based, Time-Decay) su ugašeni 2023.",
    shortDefinitionEn: "Attribution Model is a rule for assigning credit for a conversion across multiple touchpoints in the customer journey. Google Ads today uses Data-Driven Attribution as the default; older models (Linear, Position-Based, Time-Decay) were shut down in 2023.",
  ...
  // ────────── OPTIMIZATION (15) ──────────
  {
    ...
    definitionSr: "QS se izračunava po keyword-u, ne po kampanji ili oglasu. Sastoji se od 3 komponente: Expected CTR, Ad Relevance, Landing Page Experience (Google ne objavljuje tačne težine). Prosečan QS ispod 5 je crveno zastava - znači CPC plaćate 100-200% više od konkurencije sa QS 8+. Poboljšanje QS-a je najjednostavnije optimizacija za brzo smanjenje CPC-a.",
    definitionEn: "QS is calculated per keyword, not per campaign or ad. It consists of 3 components: Expected CTR, Ad Relevance, Landing Page Experience (Google doesn't publish the exact weighting). Average QS below 5 is a red flag - you're paying 100-200% more in CPC than competitors with QS 8+. Improving QS is the simplest optimization for quickly reducing CPC.",
  ...
  },
  {
    ...
    category: "optimization",
    shortDefinitionSr: "Expected CTR je Google-ova procena verovatnoće da će vaš oglas biti kliknut, prilagođena za poziciju. Sastavni deo Quality Score-a (Google ne objavljuje tačnu težinu).",
    shortDefinitionEn: "Expected CTR is Google's prediction of how likely your ad is to be clicked, adjusted for position. Component of Quality Score (Google doesn't publish the exact weight).",
