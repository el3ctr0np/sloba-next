...
export function generateMetadata(): Metadata {
  return {
    ...
    description:
      "1-na-1 Google Ads konsultacije sa sertifikovanim strucnjakom. Strategija, audit, second opinion. EUR 80/sat. Zakazite termin."
  };
}

const reasons = [
  {
    title: "Imate interni tim, treba vam ekspertska podrska",
    description:
      "Vas tim vodi kampanje, a treba im external expert za teza pitanja i validaciju."
  },
  {
  ...
  },
  {
    ...
    description:
      "Vas tim implementira, a vi trebate nekoga ko postavlja pravac."
  }
];

const topics = [
  "Google Ads strategija (kanal, tipovi kampanja, budzet)",
...
const formats = [
  ...
  },
  {
    ...
    description:
      "Pregled kampanja, strategijska pitanja, training sesija, second opinion. Ukljucuje pisani summary."
  },
  {
    title: "Deep Dive (2 sata) - EUR 150",
    description:
      "Detaljan account review, kompleksna diskusija, team training. Ukljucuje detaljan pisani report."
  },
  {
    title: "Retainer (4 sata/mesecno) - EUR 280",
    description:
      "Ongoing podrska za in-house timove. Priority scheduling i Slack pristup."
  }
];
...
const faqs = [
  ...
  {
    question: "Sta ako mi treba vise vremena?",
    answer:
      "Mozemo produziti ako sam dostupan ili zakazati follow-up."
  },
  {
  ...
  },
  {
    ...
    answer:
      "Cena konsultacije se odbija od prvog meseca ako se odlucite u roku od 30 dana."
  }
];
  ...
  return (
    <>
      ...
      <Section background="gray">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-gray-900 mb-6">
            1-na-1 konsultacije - ekspertski savet za vasa specificna pitanja
          </h1>
          <p className="text-lg text-gray-700 mb-8">
            Ponekad vam ne treba full management, vec samo ekspertski savet.
            Google Ads konsultacije su idealne kada imate konkretna pitanja,
            trebate second opinion ili zelite strategijsku pomoc bez dugorocne
            obaveze. Za EUR 80/sat dobijate punu paznju i ekspertizu iz 10+
      ...
      <Section background="gray">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-heading font-bold mb-4">
            Ko najcesce koristi konsultacije
          </h2>
        </div>
        <div className="max-w-3xl mx-auto">
          <Card className="h-full">
      ...
      <Section background="gray">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-heading font-bold mb-4">
            Imate pitanje? Zakazite konsultaciju
          </h2>
