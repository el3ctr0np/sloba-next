...
export function generateMetadata(): Metadata {
  return {
    title: "DesignerGlasses Case Study | Slobodan Jelisavac",
    description: "Rezultati za DesignerGlasses: ROI 3.9x i rast prihoda."
  };
}

export default function DesignerGlassesCaseStudyPage() {
  return (
    <>
      <Section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="h-full">
              ...
              <p className="text-3xl font-bold text-primary">ROI: 3.9x</p>
            </Card>
            <Card className="h-full">
