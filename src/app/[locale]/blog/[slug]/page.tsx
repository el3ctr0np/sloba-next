...
const faqSchemaChatGptAdsSR = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Da li su OpenAI Ads i ChatGPT Ads isto?", acceptedAnswer: { "@type": "Answer", text: "Da. OpenAI Ads je naziv platforme za oglašivače na ads.openai.com; ChatGPT Ads je kako većina ljudi, pa i sam OpenAI help centar, naziva oglase koji se pojavljuju u ChatGPT-u. Isti proizvod." } },
    { "@type": "Question", name: "Koliki budžet izdvojiti za test ChatGPT Ads?", acceptedAnswer: { "@type": "Answer", text: "Tretiram ga kao testiranje svakog drugog kanala: oko 10% budžeta, izdvojeno dodatno na ono što već trošite, ne preusmereno iz kanala koji radi. Nezavisno od toga, važe minimalni budžeti kampanje po tržištu, na primer 25 dolara u SAD i 15 funti u UK, pa 10% mora da pređe te minimume da bi test uopšte bio izvodljiv." } },
  ],
};
...
const faqSchemaChatGptAdsEN = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Are OpenAI Ads and ChatGPT Ads the same thing?", acceptedAnswer: { "@type": "Answer", text: "Yes. OpenAI Ads is the name of the advertiser platform at ads.openai.com; ChatGPT Ads is what most people, including OpenAI's own help centre, call the ads that show up inside ChatGPT. Same product." } },
    { "@type": "Question", name: "How much budget should I set aside to test ChatGPT Ads?", acceptedAnswer: { "@type": "Answer", text: "I treat it like testing any other channel: roughly 10% of budget, set aside on top of what you already spend, not diverted from a channel that is working. Separately, per-market campaign minimums still apply, for example $25 in the US and £15 in the UK, so the 10% has to clear those minimums before it is a workable test." } },
  ],
};
...
const faqSchemaAuditSR = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Koliko često treba raditi Google Ads audit?", acceptedAnswer: { "@type": "Answer", text: "Preporučujem kvartalni deep audit (2-4 sata, svih 12 kategorija + 100+ checkpoint-a) + mesečni quick audit (30 min, 8 priority checkpoint-a). Takođe radite audit odmah ako: (1) performance naglo padne, (2) preuzimate nalog od druge agencije, (3) pokrećete nove proizvode/usluge, ili (4) menjate biznis model." } },
    { "@type": "Question", name: "Šta proveriti prvo u Google Ads auditu?", acceptedAnswer: { "@type": "Answer", text: "Pet tačaka koje pokrivaju 80% problema: 1) Conversion tracking - da li se prate prave akcije? 2) Search Terms Report - koji upiti aktiviraju vaše oglase? 3) Quality Score - da li su ključne reči relevantne? 4) Wasted spend - gde novac odlazi bez rezultata? 5) Landing page - konvertuje li stranica na koju šaljete saobraćaj?" } },
    { "@type": "Question", name: "Koliko košta profesionalan Google Ads audit?", acceptedAnswer: { "@type": "Answer", text: "Cena kreće od €450 - to je moj Deep Audit + Action Plan, gde lično prolazim kroz nalog i dajem prioritizovan akcioni plan (vidi šta audit pokriva). Konačna cena zavisi od veličine naloga, broja kampanja i broja tržišta. Ako vam je mesečni ad spend €5K+, investicija se po pravilu isplati u prvom mesecu jer audit u proseku otkriva 15-25% budžeta koji se troši neefikasno." } },
    { "@type": "Question", name: "Mogu li sam da radim Google Ads audit ili mi treba specialist?", acceptedAnswer: { "@type": "Answer", text: "Možete sami ako pratite checklist iz ovog vodiča i imate tehničko razumevanje Google Ads-a. Međutim, specialist ili agencija će brže identifikovati probleme jer vide 10-20+ naloga mesečno i znaju šta je \"normal\" vs \"red flag\". Takođe, spoljni pogled eliminiše confirmation bias. Ako je ad spend €3K+ mesečno, preporučujem da bar jednom godišnje platite profesionalan Google Ads audit za second opinion." } },
    { "@type": "Question", name: "Šta je najčešći problem koji Google Ads audit otkriva?", acceptedAnswer: { "@type": "Answer", text: "Top 3 problema su: (1) Irelevantni search terms - troše 15-30% budžeta jer nema negative keywords liste ili se ne održava, (2) Conversion tracking ne funkcioniše tačno - ne radi ili beleži duplirane konverzije, pa algoritam donosi loše odluke, (3) Loša budget alokacija - loše kampanje troše previše, dobre kampanje limited by budget." } },
    { "@type": "Question", name: "Koliko vremena treba da prođe između audit-a i vidljivih rezultata?", acceptedAnswer: { "@type": "Answer", text: "Quick wins (dodavanje negative keywords, isključivanje Display Network-a iz Search kampanja, budget reallocation) daju rezultate za 7-14 dana. Srednje optimizacije (ad copy improvement, bidding adjustments) za 2-4 nedelje. Dublje promene (restructuring kampanja, nova bidding strategija) mogu zahtevati 4-8 nedelja. Smart Bidding uvek ima 7-14 dana learning period posle svake promene." } },
    { "@type": "Question", name: "Šta posle Google Ads audit-a - ko implementira optimizacije?", acceptedAnswer: { "@type": "Answer", text: "Zavisi od dogovora i vaših resursa. Neki specialist-i daju samo audit report sa priori zovanim preporukama (DIY implementation). Drugi nude audit + implementation kao package. Treći nude audit + ongoing management (mesečno upravljanje). Preporučujem da implementation radi ista osoba koja je radila audit jer poznaje kontekst, prioritete, i razloge iza svake preporuke." } },
  ]
};
...
const faqSchemaSearchKampanjeEN = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "How much does managing Google Search campaigns cost?", acceptedAnswer: { "@type": "Answer", text: "As a standalone channel, Search budget starts at $500/month. As part of full account management (Search + Shopping/PMax + remarketing), management fees start at $2,500/month. A one-off consultation is $200/hour — useful if you want a second opinion on an existing campaign without handing over management. The exact price depends on account size and complexity — you get it after I look at the account, not before." } },
...
const faqSchemaChecklistUpravljanjaSR = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Postoji li Google Ads checklista koja važi za svaki nalog?", acceptedAnswer: { "@type": "Answer", text: "Ne. Postoji ritam koji važi za svaki nalog, a sadržaj tog ritma se izvodi iz broja konverzija i načina na koji nalog prodaje." } },
    { "@type": "Question", name: "Koliko često treba proveravati Google Ads nalog?", acceptedAnswer: { "@type": "Answer", text: "Dnevno se proverava da li nalog uopšte radi i da li potrošnja odstupa od proseka. Sve ostalo ide na nedeljni, mesečni ili kvartalni ritam, u zavisnosti od broja konverzija." } },
    { "@type": "Question", name: "Kada je bezbedno menjati bid strategiju?", acceptedAnswer: { "@type": "Answer", text: "Kad imate dovoljno konverzija da promena može da se izmeri. Ispod pedeset konverzija mesečno svaka promena je nagađanje. Nov nalog ostavite oko devedeset dana pre ozbiljnih zaključaka." } },
    { "@type": "Question", name: "Treba li primenjivati preporuke iz Google Ads panela?", acceptedAnswer: { "@type": "Answer", text: "Ja ih ne primenjujem. One ne poznaju kontekst vašeg naloga i najčešće predlažu potez koji je tačan u proseku a pogrešan kod vas." } },
    { "@type": "Question", name: "Koliko vremena nedeljno traži jedan nalog?", acceptedAnswer: { "@type": "Answer", text: "Ne dajem cifru jer bi bila izmišljena. Zavisi od veličine naloga, broja kampanja i toga koliko je merenje pouzdano. Nekad je nedeljni ritam previše, nekad jedva dovoljno." } },
  ],
};
...
const faqSchemaChecklistUpravljanjaEN = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is there a Google Ads checklist that works for every account?", acceptedAnswer: { "@type": "Answer", text: "No. What works for every account is a rhythm, and the content of that rhythm is derived from the conversion count and how the account sells." } },
    { "@type": "Question", name: "How often should you check a Google Ads account?", acceptedAnswer: { "@type": "Answer", text: "Daily, you check whether the account is running at all and whether spend is off from the average. Everything else moves to a weekly, monthly, or quarterly rhythm, depending on the conversion count." } },
    { "@type": "Question", name: "When is it safe to change the bid strategy?", acceptedAnswer: { "@type": "Answer", text: "When you have enough conversions for the change to be measurable. Under fifty conversions a month, every change is a guess. Leave a new account for roughly ninety days before drawing serious conclusions." } },
    { "@type": "Question", name: "Should you follow the recommendations in the Google Ads panel?", acceptedAnswer: { "@type": "Answer", text: "I don't. They don't know the context of your account, and they most often suggest a move that's correct on average and wrong for you." } },
    { "@type": "Question", name: "How much time a week does an account need?", acceptedAnswer: { "@type": "Answer", text: "I'm not giving a figure, because it would be made up. It depends on the size of the account, the number of campaigns, and how reliable the measurement is. Sometimes a weekly rhythm is too much, sometimes it's barely enough." } },
  ],
};
...
const howToSchemaApiBasicAccessSR = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  name: "Kako do Google Ads API Basic Access nivoa (posle ukidanja developer tokena)",
  totalTime: "PT1H",
  step: [
    { "@type": "HowToStep", name: "Utvrdite koji Cloud projekat stoji iza vaših poziva", text: "Od 9. septembra 2026. nivo pristupa nosi Google Cloud projekat iz kog su izvučeni vaši OAuth kredencijali, a ne developer token. Broj projekta pročitate iz prefiksa client ID-ja. Ako imate više projekata, kredencijali iz pogrešnog padaju na Test nivo i ne vide produkcijske naloge." },
    { "@type": "HowToStep", name: "Završite brand verification na tom projektu", text: "U Google Cloud Console pod OAuth consent screen podesite User type na External i publishing status na In production, popunite Branding tab, kliknite Verify branding (do 5 minuta) i objavite rezultat u roku od 7 dana. Za nove Basic i Standard prijave ovo je preduslov, a ne opcioni korak." },
    { "@type": "HowToStep", name: "Zatražite Basic nivo u Google Cloud Console-u", text: "Nadogradnja se traži na Google Ads API stranici vašeg Cloud projekta, ne više u API Center-u. Google navodi da je odobrenje za Basic automatizovano i da stiže u roku od nekoliko minuta posle brand verifikacije. Budite konkretni oko slučaja upotrebe, navedite servise koje zovete, koristite poslovni email na svom domenu i proverite da je URL firme tačan i da sajt odgovara." },
    { "@type": "HowToStep", name: "Ako prijava bude vraćena na dopunu, odgovorite u postojećem thread-u", text: "Ne šaljite formu ponovo sa istim odgovorima, jer ćete dobiti isti odgovor. Odgovorite na isti broj slučaja, priložite detaljan opis biznis modela i slučaja upotrebe sa konkretnim brojem dnevnih operacija, i proverite da developer kontakt email odgovara sandučetu koje zaista pratite." },
  ],
};
...
const howToSchemaApiBasicAccessEN = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  name: "How to get Google Ads API Basic Access (after the developer token retirement)",
  totalTime: "PT1H",
  step: [
    { "@type": "HowToStep", name: "Identify the Cloud project behind your calls", text: "Since September 9, 2026, the access level is carried by the Google Cloud project your OAuth credentials come from, not by a developer token. Read the project number from your client ID prefix. If you run several projects, credentials from the wrong one drop to Test level and cannot see production accounts." },
    { "@type": "HowToStep", name: "Complete brand verification on that project", text: "In Google Cloud Console under the OAuth consent screen, set User type to External and the publishing status to In production, complete the Branding tab, click Verify branding (up to 5 minutes) and publish the result within 7 days. For new Basic and Standard applications this is a prerequisite, not an optional step." },
    { "@type": "HowToStep", name: "Request Basic access in Google Cloud Console", text: "The upgrade is requested on your Cloud project's Google Ads API page, no longer in the API Center. Google says Basic approval is automated and arrives within minutes of brand verification. Be specific about your use case, name the services you call, use a business email on your own domain, and check that your company URL is correct and the site responds." },
    { "@type": "HowToStep", name: "If the application comes back for more information, reply in the existing thread", text: "Do not resubmit the form with the same answers, because you will get the same reply. Answer on the same case number, attach a detailed description of your business model and use case with concrete daily operation counts, and make sure the developer contact email matches a mailbox you actually watch." },
  ],
};
