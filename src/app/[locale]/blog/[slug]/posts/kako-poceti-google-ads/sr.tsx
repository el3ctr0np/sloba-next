...
export default function KakoPocetiGoogleAdsSR() {
  return (
    <>
      ...
      <div className="bg-slate-900 text-white border-2 border-gray-900 rounded-xl p-6 md:p-8 my-8 shadow-card">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          <div className="text-center">
            <p className="text-2xl md:text-3xl font-heading font-bold text-yellow-400">5 koraka</p>
            <p className="text-xs text-slate-400 mt-1">do prve kampanje</p>
          </div>
          <div className="text-center">
            <p className="text-2xl md:text-3xl font-heading font-bold text-yellow-400">€10-20/dan</p>
            <p className="text-xs text-slate-400 mt-1">minimalni test budžet</p>
          </div>
          <div className="text-center">
            <p className="text-2xl md:text-3xl font-heading font-bold text-yellow-400">2-4 nedelje</p>
            <p className="text-xs text-slate-400 mt-1">za prve rezultate</p>
          </div>
          <div className="text-center">
            <p className="text-2xl md:text-3xl font-heading font-bold text-yellow-400">70%</p>
            <p className="text-xs text-slate-400 mt-1">početnika pravi iste greške</p>
          </div>
        </div>
      </div>
      ...
      <p>
        CPC (cena po kliku) dramatično varira zavisno od tržišta i konkurencije. Evo realnih okvirnih vrednosti za različite regione:
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-6">
        ...
        <Link href={{ pathname: "/blog/[slug]", params: { slug: "conversion-tracking-vodic" } }} className="block bg-white border-2 border-gray-200 rounded-xl p-4 hover:border-gray-900 transition-colors no-underline">
          ...
          <p className="text-xs text-gray-500 mb-0">Kako pravilno podesiti praćenje konverzija i ne gubiti budžet na podatke koji ništa ne govore.</p>
        </Link>
        <Link href={{ pathname: "/blog/[slug]", params: { slug: "kljucne-reci-vodic" } }} className="block bg-white border-2 border-gray-200 rounded-xl p-4 hover:border-gray-900 transition-colors no-underline">
          <p className="font-heading font-semibold text-gray-900 mb-1 text-sm">Istraživanje ključnih reči: vodič za početnike</p>
          <p className="text-xs text-gray-500 mb-0">Pronađite ključne reči koje vaša publika stvarno koristi i izgradite kampanju oko namere, ne pretpostavki.</p>
        </Link>
