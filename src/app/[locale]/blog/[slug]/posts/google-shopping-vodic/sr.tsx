    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Ljudi pretražuju specifične proizvode sa namerom kupovine, ne istraživanja.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          <p className="text-xs uppercase tracking-wider text-gray-500 mb-2">Prednost</p>
          <h3 className="text-base font-heading font-bold mt-0 mb-2">Cena vidljiva odmah</h3>
          <p className="text-base text-gray-600 mb-0">Transparentnost eliminuše klikove od korisnika kojima je proizvod preskup.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          <p className="text-xs uppercase tracking-wider text-gray-500 mb-2">Prednost</p>
        ...
        <table className="w-full border-collapse text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3">Jedinstveni ID proizvoda</td>
              <td className="py-3 px-3">SKU-12345</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">title</td>
              <td className="py-3 px-3">Naziv proizvoda</td>
              <td className="py-3 px-3">Nike Air Max 90 Muške Bele Patike 43</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">description</td>
              <td className="py-3 px-3">Opis proizvoda</td>
              <td className="py-3 px-3">Detaljni opis sa specifikacijama</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">link</td>
              <td className="py-3 px-3">URL proizvoda</td>
              <td className="py-3 px-3">https://shop.rs/product/12345</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">image_link</td>
              <td className="py-3 px-3">URL glavne slike</td>
              <td className="py-3 px-3">https://shop.rs/images/12345.jpg</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">price</td>
              <td className="py-3 px-3">Cena proizvoda</td>
              <td className="py-3 px-3">12990.00 RSD</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">availability</td>
              <td className="py-3 px-3">Dostupnost</td>
              <td className="py-3 px-3">in stock</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">brand</td>
              <td className="py-3 px-3">Brend proizvoda</td>
              <td className="py-3 px-3">Nike</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">gtin</td>
              <td className="py-3 px-3">Barkod (GTIN/EAN)</td>
              <td className="py-3 px-3">1234567890123</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">condition</td>
              <td className="py-3 px-3">Stanje proizvoda</td>
              <td className="py-3 px-3">new</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              <th className="py-3 px-3 font-heading font-semibold">Label</th>
              <th className="py-3 px-3 font-heading font-semibold">Svrha</th>
              <th className="py-3 px-3 font-heading font-semibold">Vrednosti</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">custom_label_0</td>
              <td className="py-3 px-3">Marža proizvoda</td>
              <td className="py-3 px-3">high_margin, medium_margin, low_margin</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">custom_label_1</td>
              <td className="py-3 px-3">Performanse</td>
              <td className="py-3 px-3">best_seller, standard, slow_mover</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">custom_label_2</td>
              <td className="py-3 px-3">Sezona</td>
              <td className="py-3 px-3">spring, summer, fall, winter</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">custom_label_3</td>
              <td className="py-3 px-3">Cenovni rang</td>
              <td className="py-3 px-3">under_50, 50_100, over_100</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">custom_label_4</td>
              <td className="py-3 px-3">Promo status</td>
              <td className="py-3 px-3">on_sale, full_price</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg p-4 my-6">
        ...
        <p className="text-yellow-800 text-base mb-0">Custom Labels vam omogućavaju da kreirate kampanje po marži (visoka marža = veći bid), po performansama (top performeri = posebna kampanja), ili po sezoni (isključite zimske proizvode leti).</p>
      </div>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              ...
              <th className="py-3 px-3 font-heading font-semibold">Minimum zahtevi</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Manual CPC</td>
              <td className="py-3 px-3">Nova kampanja, skupljanje podataka, mali budžet</td>
              <td className="py-3 px-3">Nema zahteva</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Target ROAS</td>
              <td className="py-3 px-3">Stabilna kampanja, jasne vrednosti konverzija</td>
              <td className="py-3 px-3">50+ konverzija/mesečno</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Maximize Clicks</td>
              <td className="py-3 px-3">Početak, skupljanje saobraćaja</td>
              <td className="py-3 px-3">Nema zahteva</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Maximize Conversion Value</td>
              <td className="py-3 px-3">Dovoljno konverzija, bez specificnog ROAS targeta</td>
              <td className="py-3 px-3">30+ konverzija/mesečno</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <p className="text-base text-gray-600 mb-3">Potpuna kontrola nad bidovima. Svaka promena bida je odmah aktivna. Nema learning perioda. Idealno za početak ili male budžete.</p>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <p className="text-base text-gray-600 mb-3">Automatska optimizacija ka target ROAS-u. Google koristi device, location, time, i audience signale. Manje ručnog rada, ali potreban learning period.</p>
        <p className="text-sm font-semibold mb-1">Kada koristiti:</p>
        <ul className="text-base mb-0">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <p className="text-base text-gray-500 mb-0">Očekivani rezultat: 10-30% poboljšanje CTR i Conversion Rate.</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <p className="text-base text-gray-600 mb-3">Shopping koristi feed za targeting, ali možete dodati negative keywords da filtrirate nekvalifikovan saobraćaj.</p>
        <ul className="text-base mb-3">
        ...
        <p className="text-base text-gray-500 mb-0">Preporučujem nedeljni review Search Terms report-a i agresivno dodavanje negatives. Ovo je najbrži način da poboljšate CTR i smanjite CPC.</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <p className="text-base text-gray-600 mb-3">Device, location, i time adjustments mogu značajno poboljšati ROAS.</p>
        <ul className="text-base mb-0">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <p className="text-base text-gray-600 mb-3">Dodajte audience liste i podignite bidove za korisnike koji već poznaju vaš brend.</p>
        <ul className="text-base mb-3">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <p className="text-base text-gray-600 mb-3">Ne svi proizvodi zaslužuju budžet. Preporučujem da isključite:</p>
        <ul className="text-base mb-3">
        ...
        <p className="text-base text-gray-500 mb-0">Koristite custom labels da lakše segmentirate i isključujete. Ovo oslobađa budžet za top performere.</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <p className="text-base text-gray-600 mb-3">Google prikazuje cenu u oglasu. Ako ste 30% skuplji od konkurencije, CTR će patiti.</p>
        <ul className="text-base mb-0">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 my-4">
        ...
        <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
          <p className="text-base text-green-800 mb-0"><strong>Rešenje:</strong> Segmentacija po kategoriji, marži ili performansama. Jedan bid za sve proizvode znači da gubite novac na low performers i ne maksimizujete top performere.</p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 my-4">
        ...
        <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
          <p className="text-base text-green-800 mb-0"><strong>Rešenje:</strong> Proverite Merchant Center Price Competitiveness report. Ako ste 25% skuplji od konkurencije, CTR će patiti. Prilagodite cene ili fokusirajte budžet na proizvode gde ste konkurentni.</p>
        </div>
      </div>
      ...
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Kontrola bidova</td>
              <td className="py-3 px-3">Potpuna kontrola</td>
              <td className="py-3 px-3">Minimalna kontrola</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Search terms</td>
              <td className="py-3 px-3">Jasan uvid</td>
              <td className="py-3 px-3">Ograničen uvid</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Placements</td>
              <td className="py-3 px-3">Samo Shopping</td>
              <td className="py-3 px-3">Svi Google placements</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Learning period</td>
              <td className="py-3 px-3">Brži</td>
              <td className="py-3 px-3">Sporiji (2-3 nedelje)</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Ručni rad</td>
              <td className="py-3 px-3">Više</td>
              <td className="py-3 px-3">Manje</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Use case</td>
              <td className="py-3 px-3">Kontrola, ROAS fokus</td>
              <td className="py-3 px-3">Prospecting, reach</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg p-4 my-6">
        <p className="font-semibold text-yellow-900 mb-1">Važno</p>
        <p className="text-yellow-800 text-base mb-0"><strong>Cena mismatch:</strong> Cena u feed-u mora biti identična ceni na sajtu. Ako je razlika veća od 10%, Google disapprove-uje proizvod.</p>
      </div>

      <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg p-4 my-6">
        <p className="font-semibold text-yellow-900 mb-1">Važno</p>
        <p className="text-yellow-800 text-base mb-0"><strong>Dostupnost mismatch:</strong> Ako je proizvod "in stock" u feed-u ali "out of stock" na sajtu, Google disapprove-uje proizvod. Automatizujte feed update.</p>
      </div>

      <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg p-4 my-6">
        <p className="font-semibold text-yellow-900 mb-1">Važno</p>
        <p className="text-yellow-800 text-base mb-0"><strong>Missing information:</strong> Nedostaje GTIN, brand ili slika. Ako nemate GTIN, obavezno popunite brand + MPN. Ako nemate ni MPN, prijavite se za exemption.</p>
      </div>

      <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg p-4 my-6">
        <p className="font-semibold text-yellow-900 mb-1">Važno</p>
        <p className="text-yellow-800 text-base mb-0"><strong>Policy violation:</strong> Zabranjeni proizvodi (oružje, lekovi, alkohol) ili promotional claims u title/description ("Najbolja ponuda!", "Sale 50%!"). Budite deskriptivni, ne promocionalni.</p>
      </div>
