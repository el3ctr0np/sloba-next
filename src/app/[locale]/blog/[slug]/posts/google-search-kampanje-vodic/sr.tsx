  ...
  return (
    <>
      ...
      <div className="bg-slate-900 text-white border border-gray-200 rounded-xl p-6 md:p-8 my-8 shadow-card">
        ...
        <p className="text-xs text-slate-500 mt-4 mb-0">*Po Google-ovim podacima: prosečno 7% više konverzija ili conversion value pri sličnom CPA/ROAS, uz punu AI Max suitu vs samo search term matching.</p>
      </div>
