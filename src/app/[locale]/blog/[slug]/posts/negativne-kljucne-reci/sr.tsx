    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Definišu za koje pretrage se vaš oglas prikazuje. Privlače saobraćaj ka vašem sajtu.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Sprečavaju prikazivanje za irelevantne pretrage. Štite budžet od wasted spend-a.</p>
        </div>
      </div>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              ...
              <th className="py-3 px-3 font-heading font-semibold">Sintaksa</th>
              <th className="py-3 px-3 font-heading font-semibold">Blokira</th>
              <th className="py-3 px-3 font-heading font-semibold">Ne blokira</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Negative Broad</td>
              <td className="py-3 px-3">besplatno</td>
              <td className="py-3 px-3">Svaku pretragu sa tom reči, bilo koji redosled</td>
              <td className="py-3 px-3">Varijacije i sinonime ({`"besplatni"`}, {`"free"`})</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Negative Phrase</td>
              <td className="py-3 px-3">{`"besplatno preuzimanje"`}</td>
              <td className="py-3 px-3">Pretrage sa tačnom frazom u tom redosledu</td>
              <td className="py-3 px-3">Drugačiji redosled ({`"preuzimanje besplatno"`})</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Negative Exact</td>
              <td className="py-3 px-3">[besplatno preuzimanje]</td>
              <td className="py-3 px-3">Samo tu tačnu pretragu</td>
              <td className="py-3 px-3">Bilo šta dodatno ({`"besplatno preuzimanje CRM"`})</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              ...
              <th className="py-3 px-3 font-heading font-semibold">Gde se dodaje</th>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Pogledajte <Link href={{ pathname: "/blog/[slug]", params: { slug: "google-ads-audit-vodic" } }} className="underline font-semibold">Google Ads audit checklist</Link> za kompletnu reviziju naloga.</p>
        </div>
      </div>
      ...
      <div className="space-y-4 my-6">
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Rešenje:</strong> Postavite nedeljni reminder za Search Terms review. Ovo je najvažnija optimizaciona aktivnost za negativne reči.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Rešenje:</strong> Proverite volume i konverzije pre dodavanja. Možda neka reč izgleda irelevantno ali zapravo konvertuje.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Rešenje:</strong> Dodajte i srpske i engleske verzije. Blokirajte {`"besplatno"`} I {`"free"`}, {`"posao"`} I {`"job"`}. Negative Broad ne hvata sinonime automatski.</p>
          </div>
        </div>
      </div>
