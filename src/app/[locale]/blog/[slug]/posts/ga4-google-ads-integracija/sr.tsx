    ...
    <>
      ...
      <nav className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-8 shadow-card">
        ...
        <ol className="space-y-1.5 list-none pl-0 mb-0">
          <li><a href="#sta-je-ga4-link" className="block py-1 text-base text-gray-700 hover:text-primary underline">Šta je GA4 + Google Ads integracija</a></li>
          <li><a href="#preduslovi" className="block py-1 text-base text-gray-700 hover:text-primary underline">Preduslovi (pre nego krenete)</a></li>
          <li><a href="#koraci" className="block py-1 text-base text-gray-700 hover:text-primary underline">7 koraka setup-a</a></li>
          ...
          <li><a href="#consent-mode" className="block py-1 text-base text-gray-700 hover:text-primary underline">Consent Mode v2 (EU obavezno)</a></li>
          <li><a href="#greske" className="block py-1 text-base text-gray-700 hover:text-primary underline">Najčešće greške</a></li>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Key event iz GA4 (purchase, generate_lead) možete importovati kao Google Ads konverziju. Smart Bidding koristi ovu konverziju za optimizaciju.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Audience kreiran u GA4 (&quot;cart abandoners&quot;, &quot;30-day viewers&quot;) se automatski prenosi u Google Ads Audience Manager.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">GCLID (Google Click ID) se mapira u GA4 pa u Acquisition reportu vidite kampanju, ad grupu i keyword koji je doveo korisnika.</p>
        </div>
      </div>
      ...
      <div className="space-y-4 my-6">
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Gde:</strong> GA4 → Admin → Events → Mark as key event (toggle)</p>
            <p className="text-base text-gray-600 mb-2">Označite kao key event:</p>
            <ul className="text-base text-gray-600 mb-2">
            ...
            <p className="text-base text-gray-600 mb-0">Napomena: od marta 2024, GA4 je preimenovao &quot;conversions&quot; u &quot;key events&quot;. Funkcija je ista.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Gde:</strong> Google Ads → Tools → Data Manager → Connected products → Google Analytics 4 → Import conversions</p>
            <p className="text-base text-gray-600 mb-2">Redosled klikova:</p>
            ...
            <p className="text-base text-gray-600 mb-0">Nakon importa, konverzija se pojavljuje na Google Ads → Goals → Summary sa izvorom &quot;Google Analytics (GA4)&quot;.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Gde:</strong> Google Ads → Goals → Conversions → Goal settings</p>
            <p className="text-base text-gray-600 mb-2">Pravilo: <strong>samo jedna konverzija treba da bude Primary</strong> (ta se koristi za Smart Bidding). Sve ostale idu na Secondary (observation only, ne utiču na bidding).</p>
            ...
            <p className="text-base text-gray-600 mb-0">Greška koju vidim stalno: eCommerce klijent ima &quot;One&quot; count i Smart Bidding zna samo za pola vrednosti.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Gde:</strong> GA4 → Admin → Audiences → New audience</p>
            <p className="text-base text-gray-600 mb-2">Ako je link aktivan (Korak 1), audience se automatski sinhronizuje u Google Ads Audience Manager u roku od 24h. Minimum 1,000 aktivnih korisnika potrebno da audience postane eligible za remarketing.</p>
            <p className="text-base text-gray-600 mb-0">Tipične audiences koje prenosim: <em>cart abandoners (7 days)</em>, <em>30-day all users</em>, <em>purchased last 90 days</em>, <em>video viewers (50%)</em>.</p>
          </div>
        </div>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              <th className="py-3 px-3 font-heading font-semibold">Biznis model</th>
              <th className="py-3 px-3 font-heading font-semibold">GA4 Key Event</th>
              <th className="py-3 px-3 font-heading font-semibold">Google Ads klasifikacija</th>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              ...
              <th className="py-3 px-3 font-heading font-semibold">Kako radi</th>
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3">ML model razvija per-kampanja kredit baziran na stvarnom customer path-u</td>
              <td className="py-3 px-3 text-green-700">Default za naloge sa 300+ konverzija/30 dana</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Ads-preferred last click</td>
              <td className="py-3 px-3">Kredit ide zadnjem Google Ads kliku pre konverzije</td>
              <td className="py-3 px-3">Manji nalozi (&lt;300 conv/mesec)</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Last click (GA4 default)</td>
              <td className="py-3 px-3">Svi kanali dobijaju kredit bazirano na zadnjem non-direct kliku</td>
              <td className="py-3 px-3">Cross-channel analiza u GA4, ne u Google Ads bidding-u</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="space-y-4 my-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Rešenje:</strong> Obavezno v2 za EU. Efekti v1 u 2026: remarketing liste se ne pune (EU korisnici ne ulaze), Smart Bidding ima manje signala, conversion modeling ne radi.</p>
          </div>
        </div>
      </div>
