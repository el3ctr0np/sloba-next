    ...
    <>
      ...
      <nav className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-8 shadow-card">
        ...
        <ol className="space-y-1.5 list-none pl-0 mb-0">
          <li><a href="#what-is-ga4-link" className="block py-1 text-base text-gray-700 hover:text-primary underline">What is GA4 + Google Ads integration</a></li>
          <li><a href="#prerequisites" className="block py-1 text-base text-gray-700 hover:text-primary underline">Prerequisites (before you start)</a></li>
          <li><a href="#steps" className="block py-1 text-base text-gray-700 hover:text-primary underline">7 setup steps</a></li>
          <li><a href="#event-mapping" className="block py-1 text-base text-gray-700 hover:text-primary underline">GA4 event → Google Ads action mapping</a></li>
          <li><a href="#attribution" className="block py-1 text-base text-gray-700 hover:text-primary underline">Attribution model: Ads-preferred vs Data-driven</a></li>
          <li><a href="#consent-mode" className="block py-1 text-base text-gray-700 hover:text-primary underline">Consent Mode v2 (EU mandatory)</a></li>
          <li><a href="#mistakes" className="block py-1 text-base text-gray-700 hover:text-primary underline">Common mistakes</a></li>
          <li><a href="#troubleshooting" className="block py-1 text-base text-gray-700 hover:text-primary underline">Troubleshooting</a></li>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">A key event from GA4 (purchase, generate_lead) can be imported as a Google Ads conversion. Smart Bidding uses this conversion for optimization.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">An audience created in GA4 (&quot;cart abandoners&quot;, &quot;30-day viewers&quot;) syncs automatically into Google Ads Audience Manager.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">GCLID (Google Click ID) maps into GA4, so the Acquisition report shows the campaign, ad group, and keyword that drove the visit.</p>
        </div>
      </div>
      ...
      <div className="space-y-4 my-6">
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Where:</strong> GA4 → Admin → Property → Product links → Google Ads links → Link</p>
            <p className="text-base text-gray-600 mb-2">Select the Google Ads Customer ID (account or MCC). Make sure to tick both boxes:</p>
            ...
            <p className="text-base text-gray-600 mb-0">Click &quot;Submit&quot;. Status &quot;Linked&quot; should appear immediately.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Where:</strong> Google Ads → Admin → Account settings → Auto-tagging</p>
            <p className="text-base text-gray-600 mb-2">Tick &quot;Tag the URL that people click through from my ad&quot;. Usually on by default, but I check every new account — I&apos;ve found 3 accounts in the last year where it was turned off.</p>
            <p className="text-base text-gray-600 mb-0">Without auto-tagging, GCLID doesn&apos;t get appended to URLs and attribution between Google Ads and GA4 breaks.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Where:</strong> GA4 → Admin → Events → Mark as key event (toggle)</p>
            <p className="text-base text-gray-600 mb-2">Flag as key event:</p>
            <ul className="text-base text-gray-600 mb-2">
            ...
            <p className="text-base text-gray-600 mb-0">Note: in March 2024, GA4 renamed &quot;conversions&quot; to &quot;key events&quot;. The function is identical.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Where:</strong> Google Ads → Tools → Data Manager → Connected products → Google Analytics 4 → Import conversions</p>
            <p className="text-base text-gray-600 mb-2">Click sequence:</p>
            <ol className="text-base text-gray-600 mb-2 list-decimal pl-5">
              <li>Select the GA4 property from the connected list</li>
              <li>Select one or more key events to import</li>
              <li>Click &quot;Import&quot;</li>
            </ol>
            <p className="text-base text-gray-600 mb-0">After import, the conversion appears under Google Ads → Goals → Summary with source &quot;Google Analytics (GA4)&quot;.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Where:</strong> Google Ads → Goals → Conversions → Goal settings</p>
            <p className="text-base text-gray-600 mb-2">Rule: <strong>only one conversion should be Primary</strong> (that&apos;s what Smart Bidding optimizes for). All others go to Secondary (observation only, don&apos;t affect bidding).</p>
            <p className="text-base text-gray-600 mb-2">Count setting:</p>
            <ul className="text-base text-gray-600 mb-2">
            ...
            <p className="text-base text-gray-600 mb-0">Mistake I see all the time: eCommerce client has &quot;One&quot; count and Smart Bidding only sees half the revenue.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2"><strong>Where:</strong> GA4 → Admin → Audiences → New audience</p>
            <p className="text-base text-gray-600 mb-2">If the link is active (Step 1), audiences sync to Google Ads Audience Manager automatically within 24h. Minimum 1,000 active users required for an audience to become eligible for remarketing.</p>
            <p className="text-base text-gray-600 mb-0">Audiences I typically share: <em>cart abandoners (7 days)</em>, <em>30-day all users</em>, <em>purchased last 90 days</em>, <em>video viewers (50%)</em>.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-2">After 24–48h (not sooner), check:</p>
            <ul className="text-base text-gray-600 mb-2">
            ...
            <p className="text-base text-gray-600 mb-0">If &quot;No data&quot; after 48h — jump to the Troubleshooting section below.</p>
          </div>
        </div>
      </div>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              <th className="py-3 px-3 font-heading font-semibold">Business model</th>
              <th className="py-3 px-3 font-heading font-semibold">GA4 Key Event</th>
              <th className="py-3 px-3 font-heading font-semibold">Google Ads classification</th>
              <th className="py-3 px-3 font-heading font-semibold">Count</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">eCommerce</td>
              <td className="py-3 px-3"><code>purchase</code></td>
              <td className="py-3 px-3 text-green-700">Primary (Purchase)</td>
              <td className="py-3 px-3">Every</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">eCommerce</td>
              <td className="py-3 px-3"><code>add_to_cart</code></td>
              <td className="py-3 px-3 text-gray-600">Secondary (Observation)</td>
              <td className="py-3 px-3">One</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Lead Gen</td>
              <td className="py-3 px-3"><code>generate_lead</code></td>
              <td className="py-3 px-3 text-green-700">Primary (Submit lead form)</td>
              <td className="py-3 px-3">One</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Local Services</td>
              <td className="py-3 px-3"><code>phone_call</code> (custom)</td>
              <td className="py-3 px-3 text-green-700">Primary (Phone call lead)</td>
              <td className="py-3 px-3">One</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">SaaS</td>
              <td className="py-3 px-3"><code>trial_signup</code> (custom)</td>
              <td className="py-3 px-3 text-green-700">Primary (Sign-up)</td>
              <td className="py-3 px-3">One</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">SaaS</td>
              <td className="py-3 px-3"><code>purchase</code> (plan subscribe)</td>
              <td className="py-3 px-3 text-green-700">Primary (Subscription)</td>
              <td className="py-3 px-3">Every</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Content / Blog</td>
              <td className="py-3 px-3"><code>newsletter_signup</code></td>
              <td className="py-3 px-3 text-gray-600">Secondary (Observation)</td>
              <td className="py-3 px-3">One</td>
            </tr>
          </tbody>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              ...
              <th className="py-3 px-3 font-heading font-semibold">How it works</th>
              <th className="py-3 px-3 font-heading font-semibold">When to use</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Data-driven</td>
              <td className="py-3 px-3">ML model assigns per-touchpoint credit based on actual customer paths</td>
              <td className="py-3 px-3 text-green-700">Default for accounts with 300+ conv/30 days</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Ads-preferred last click</td>
              <td className="py-3 px-3">Credit goes to the last Google Ads click before conversion</td>
              <td className="py-3 px-3">Smaller accounts (&lt;300 conv/month)</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Last click (GA4 default)</td>
              <td className="py-3 px-3">All channels receive credit based on the last non-direct click</td>
              <td className="py-3 px-3">Cross-channel analysis in GA4, not Google Ads bidding</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="space-y-4 my-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Fix:</strong> Only one conversion should be Primary. Adding multiple Primaries (e.g. purchase + add_to_cart + newsletter) mixes signals and tROAS breaks down.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Fix:</strong> Without <code>value</code> and <code>currency</code> parameters, tROAS can&apos;t operate. Verify via GA4 DebugView that values fire. For Shopify/WooCommerce — the standard GTM template ships with this by default.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Fix:</strong> eCommerce must be &quot;Every&quot; (every purchase counts). Leads must be &quot;One&quot; (you don&apos;t want one lead to eat 3× your bid budget). Default is &quot;One&quot; — always switch for eCommerce.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Fix:</strong> v2 is mandatory in the EU. Effects of v1 in 2026: remarketing lists don&apos;t populate (EU users don&apos;t enter them), Smart Bidding has fewer signals, conversion modeling breaks.</p>
          </div>
        </div>
      </div>
