...
export default function AgencyVsFreelancerEN() {
  return (
    <>
      <div className="bg-slate-900 text-white border-2 border-gray-900 rounded-xl p-6 md:p-8 my-8 shadow-card">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-slate-400 mt-1 mb-0">Most important factor</p>
          </div>
        </div>
      </div>
      ...
      <p>I recommend thinking about three key aspects before choosing:</p>
      <ul>
        <li><strong>Fit with your industry niche</strong> — a partner who understands your industry delivers results faster</li>
        <li><strong>Communication style</strong> — do you need direct communication or formal reports?</li>
        <li><strong>Financial structure</strong> — do you have budget for fixed costs or is flexibility important?</li>
      </ul>
      ...
      <div className="bg-white border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <ul className="text-sm">
          ...
          <li>Backup when someone goes on vacation or leaves agency</li>
        </ul>
      </div>
      ...
      <div className="bg-white border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <ul className="text-sm">
          ...
          <li>Professional process documentation</li>
        </ul>
      </div>

      <h3>Main challenges working with agencies</h3>
      ...
      <p>I recommend an agency if:</p>
      <ul>
        <li>Your ad spend is over $5,000/£4,000 monthly</li>
        <li>Planning multi-channel approach (Google Ads + Meta + LinkedIn + email)</li>
        <li>Don't have internal person who can oversee campaigns</li>
        <li>Want formal structure, contracts, and regular reports</li>
        <li>Planning rapid scaling (doubling budget in next 6-12 months)</li>
      </ul>

      <h3>How agencies charge</h3>
      ...
      <p className="font-semibold">Example calculation ($5,000/£4,000 ad spend):</p>
      <ul>
        <li>Percentage model (15%): $750/£600 monthly</li>
        <li>Fixed model: $800-1,200 / £650-950 monthly</li>
        <li>Hybrid ($400 + 8% above $3,000): $560/£450 monthly</li>
      </ul>
      ...
      <div className="bg-white border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <ul className="text-sm">
          ...
          <li>Easier pivots and experimentation</li>
        </ul>
      </div>
      ...
      <div className="bg-white border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <ul className="text-sm">
          ...
          <li>No lock-in period (usually 30-day notice)</li>
        </ul>
      </div>
      ...
      <div className="bg-white border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <ul className="text-sm">
          ...
          <li>Option to grow retainer as spend grows</li>
        </ul>
      </div>

      <h3>Main challenges working with freelancers</h3>
      ...
      <h3>When to choose a freelancer</h3>
      <p>I recommend a freelancer if:</p>
      <ul>
        <li>Your ad spend is $1,000-10,000/£800-8,000 monthly</li>
        <li>Focus is on one channel (Google Ads, not multi-channel)</li>
        <li>Want deep specialization (e.g., only Google Shopping or only Lead Gen)</li>
        <li>Direct, fast communication is important</li>
        <li>Have internal person who can oversee work (at least high-level)</li>
      </ul>

      <h3>How freelancers charge</h3>
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
      ...
      <div className="bg-white border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <ul className="text-sm">
          ...
          <li>Cumulative knowledge that stays in company</li>
        </ul>
      </div>
      ...
      <h3>Main challenges of in-house team</h3>
      ...
      <h3>When to choose in-house team</h3>
      <p>I recommend in-house if:</p>
      <ul>
        <li>Your ad spend is over $15,000-20,000/£12,000-16,000 monthly</li>
        <li>Marketing is core business function (not support activity)</li>
        <li>Have resources for recruitment, onboarding, and continuous development</li>
        <li>Planning long-term (3+ years) and want to build internal expertise</li>
        <li>Full control over data and strategy is important</li>
      </ul>

      <h3>In-house team costs (US/UK, 2025-2026)</h3>
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-6">
        ...
        <Link href={{ pathname: "/blog/[slug]", params: { slug: "koliko-kosta-google-ads" } }} className="block bg-white border-2 border-gray-200 rounded-xl p-4 hover:border-gray-900 transition-colors no-underline">
          ...
          <p className="text-xs text-gray-500 mb-0">
            Complete cost analysis, budgets, and fee structures for 2026.
          </p>
        </Link>
        ...
        <Link href={{ pathname: "/blog/[slug]", params: { slug: "google-ads-audit-vodic" } }} className="block bg-white border-2 border-gray-200 rounded-xl p-4 hover:border-gray-900 transition-colors no-underline">
          <p className="font-heading font-semibold text-gray-900 mb-1 text-sm">
            Google Ads Audit — Complete Guide
          </p>
          <p className="text-xs text-gray-500 mb-0">
            How to verify quality of existing campaigns before changing partners.
          </p>
        </Link>
