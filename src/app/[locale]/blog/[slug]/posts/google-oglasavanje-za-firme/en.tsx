  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>People actively search for solutions (search volume exists)</li>
        <li>You have a competitive offer</li>
        <li>You properly set up tracking and optimize continuously</li>
      </ul>
      ...
      <div className="bg-slate-900 text-white rounded-xl p-5 my-6">
        <p className="font-heading font-semibold text-lg mb-0">Ad Rank = Bid × Quality Score × Expected impact of extensions</p>
      </div>

      <p>This means you can pay less than competitors and still rank above them — if you have better Quality Score.</p>

      <h3>Quality Score — Your hidden advantage</h3>
      <p>Quality Score (1–10) measures how relevant your ad is to users. It depends on:</p>
      <ul>
        <li><strong>CTR (Click-Through Rate)</strong> — how often people click your ad</li>
        <li><strong>Ad relevance</strong> — how well ad copy matches the search</li>
        <li><strong>Landing page experience</strong> — speed, relevance, mobile optimization</li>
      </ul>
      <p>High Quality Score = lower cost per click, better positions, more conversions for same budget.</p>

      <h3>Google Ads networks</h3>
      <p>Google Ads has multiple networks where ads appear:</p>
      ...
      <div className="bg-gray-50 border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6">
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div><strong>Brand Search</strong> <span className="text-gray-500">— Protect brand name, capture people who already know you</span></div>
          </div>
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-bold">2</span>
            <div><strong>Standard Shopping</strong> <span className="text-gray-500">— Controlled campaigns by products/categories</span></div>
          </div>
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-bold">3</span>
            <div><strong>Performance Max</strong> <span className="text-gray-500">— Scale proven products (when you have conversion history)</span></div>
          </div>
          <div className="flex items-start gap-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div><strong>Remarketing</strong> <span className="text-gray-500">— Bring back visitors who didn't buy</span></div>
          </div>
        </div>
      </div>

      <h3>Product Feed — Foundation of Shopping campaigns</h3>
      ...
      <p>The question I hear constantly: &quot;Should I use Standard Shopping or PMax?&quot;</p>
      ...
      <div className="bg-gray-50 border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6">
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-bold">1</span>
            <div><strong>Cart abandoners</strong> <span className="text-gray-500">— Added to cart, didn't buy (1–7 days) → aggressive offer</span></div>
          </div>
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-bold">2</span>
            <div><strong>Product viewers</strong> <span className="text-gray-500">— Viewed product, didn't add to cart (3–14 days) → show that product + alternatives</span></div>
          </div>
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-bold">3</span>
            <div><strong>Past customers</strong> <span className="text-gray-500">— Purchased before, potential for repeat (30–180 days) → cross-sell, up-sell</span></div>
          </div>
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center text-sm font-bold">4</span>
            <div><strong>High-value customers</strong> <span className="text-gray-500">— Multiple purchases → VIP offers, loyalty programmes</span></div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6">
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-bold">1</span>
            <div><strong>Brand Search</strong> <span className="text-gray-500">— Brand protection, capture people who already know you</span></div>
          </div>
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-bold">2</span>
          ...
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-bold">4</span>
            <div><strong>Competitor Search</strong> <span className="text-gray-500">— Competitor names (carefully, can be expensive)</span></div>
          </div>
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-8 h-8 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center text-sm font-bold">5</span>
            <div><strong>Remarketing</strong> <span className="text-gray-500">— Nurturing through longer decision process</span></div>
          </div>
        </div>
      </div>

      <h3>Key differences: B2B vs B2C</h3>
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
      ...
      <h3>Lead quality &gt; Lead quantity</h3>
      <p>Biggest mistake I see with B2B companies: focus on number of leads instead of quality.</p>
      <p>100 bad leads cost more than 10 quality ones:</p>
      <ul>
      ...
      <div className="bg-white border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <ul className="text-sm mb-3">
          ...
          <li><strong>One CTA</strong> — don't confuse with 5 options (one goal per page)</li>
      ...
      <div className="bg-white border-2 border-gray-900 rounded-xl p-5 md:p-6 my-6 shadow-card">
        ...
        <ul className="text-sm mb-0">
          ...
          <li><strong>Relevance</strong> — Can you actually deliver what the user is looking for?</li>
        </ul>
      </div>
      ...
      <h3>Benchmarks for the UK and US markets</h3>
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
      ...
      <details className="bg-white border-2 border-gray-200 rounded-xl group mb-3">
        ...
        <div className="px-5 pb-5 text-sm text-gray-600 border-t border-gray-100 pt-3">
          <ul className="mb-0">
            ...
            <li><strong>Optimized, stable account:</strong> 4–6 months</li>
          </ul>
        </div>
      </details>
      ...
      <details className="bg-white border-2 border-gray-200 rounded-xl group mb-3">
        ...
        <div className="px-5 pb-5 text-sm text-gray-600 border-t border-gray-100 pt-3">
          ...
          <ul className="mb-0">
            ...
            <li><strong>£2,000–10,000/month:</strong> Freelancer or boutique agency</li>
            <li><strong>£10,000+/month:</strong> Agency or in-house team</li>
          </ul>
        </div>
      </details>
      ...
      <details className="bg-white border-2 border-gray-200 rounded-xl group mb-3">
        ...
        <div className="px-5 pb-5 text-sm text-gray-600 border-t border-gray-100 pt-3">
          ...
          <ul className="mb-3">
            ...
            <li><strong>Facebook Ads</strong> — targets people by interests and demographics. Better for brand awareness and prospecting.</li>
          </ul>
          <p className="mb-0"><strong>Best of all:</strong> Combine both. Google for bottom-of-funnel, Facebook for top-of-funnel and remarketing.</p>
        </div>
      </details>
      ...
      <details className="bg-white border-2 border-gray-200 rounded-xl group mb-3">
        ...
        <div className="px-5 pb-5 text-sm text-gray-600 border-t border-gray-100 pt-3">
          ...
          <ul className="mb-2">
            ...
            <li>Properly setting up tracking (most critical step)</li>
            <li>Continuous optimization (weekly at minimum)</li>
            <li>Patience (results don't come overnight)</li>
          </ul>
          <p className="mb-0">If you don't have the time or have a larger budget (£2,000+), I'd recommend working with a specialist.</p>
        </div>
      </details>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-6">
        ...
        <Link href="/usluge/google-ads-upravljanje" className="block bg-white border-2 border-gray-200 rounded-xl p-4 hover:border-gray-900 transition-colors no-underline">
          ...
          <p className="text-xs text-gray-500 mb-0">Professional Google Ads campaign management</p>
        </Link>
      </div>
