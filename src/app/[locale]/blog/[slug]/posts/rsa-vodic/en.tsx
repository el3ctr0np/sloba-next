    ...
    <>
      ...
      <nav className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-8 shadow-card">
        ...
        <ol className="space-y-1.5 list-none pl-0 mb-0">
          <li><a href="#why-rsa-dominates-in-2026" className="text-base block py-1 text-gray-700 hover:text-primary underline">Why the RSA Format Dominates in 2026</a></li>
          <li><a href="#what-are-responsive-search-ads-and-how-they-work" className="text-base block py-1 text-gray-700 hover:text-primary underline">What Are Responsive Search Ads and How They Work</a></li>
          <li><a href="#why-7-8-headlines-not-15" className="text-base block py-1 text-gray-700 hover:text-primary underline">Why 7-8 Headlines, Not 15</a></li>
          <li><a href="#7-headline-types-that-cover-everything" className="text-base block py-1 text-gray-700 hover:text-primary underline">7 Headline Types That Cover Everything</a></li>
          <li><a href="#traffic-temperature-approach" className="text-base block py-1 text-gray-700 hover:text-primary underline">Traffic Temperature Approach — Match Your Tone to the Audience</a></li>
          <li><a href="#how-to-write-an-rsa-step-by-step" className="text-base block py-1 text-gray-700 hover:text-primary underline">How to Write an RSA Step by Step</a></li>
          <li><a href="#description-strategy" className="text-base block py-1 text-gray-700 hover:text-primary underline">Description Strategy</a></li>
          <li><a href="#pinning-yes-or-no" className="text-base block py-1 text-gray-700 hover:text-primary underline">Pinning — Yes or No?</a></li>
          <li><a href="#most-common-rsa-mistakes" className="text-base block py-1 text-gray-700 hover:text-primary underline">Most Common RSA Mistakes and How to Avoid Them</a></li>
          <li><a href="#rsa-testing-the-iteration-loop" className="text-base block py-1 text-gray-700 hover:text-primary underline">RSA Testing — The Iteration Loop</a></li>
          <li><a href="#frequently-asked-questions-about-rsa" className="text-base block py-1 text-gray-700 hover:text-primary underline">Frequently Asked Questions About RSA</a></li>
          <li><a href="#conclusion" className="text-base block py-1 text-gray-700 hover:text-primary underline">Conclusion</a></li>
          <li><a href="#related-guides" className="text-base block py-1 text-gray-700 hover:text-primary underline">Related Guides</a></li>
        </ol>
      </nav>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              <th className="py-3 px-3 font-heading font-semibold">No. of headlines</th>
              <th className="py-3 px-3 font-heading font-semibold">3-headline combinations</th>
              <th className="py-3 px-3 font-heading font-semibold">Min. impressions to learn</th>
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3"><span className="inline-block bg-green-100 text-green-800 text-xs font-semibold px-2 py-0.5 rounded">Optimal</span></td>
            </tr>
            ...
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3"><span className="inline-block bg-yellow-100 text-yellow-800 text-xs font-semibold px-2 py-0.5 rounded">Too many</span></td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-2">Signal that the ad is relevant to the search query.</p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-2">Your core offer plus the primary benefit.</p>
          <p className="text-xs text-gray-500 mb-1 font-semibold">Examples:</p>
          <ul className="text-sm text-gray-700 mb-0 pl-4">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-2">Why you are different from the competition.</p>
          <p className="text-xs text-gray-500 mb-1 font-semibold">Examples:</p>
          <ul className="text-sm text-gray-700 mb-0 pl-4">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-2">Trust and credibility signals.</p>
          <p className="text-xs text-gray-500 mb-1 font-semibold">Examples:</p>
          <ul className="text-sm text-gray-700 mb-0 pl-4">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-2">Remove the barrier to taking action.</p>
          <p className="text-xs text-gray-500 mb-1 font-semibold">Examples:</p>
          <ul className="text-sm text-gray-700 mb-0 pl-4">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-2">The clear action you want them to take.</p>
          <p className="text-xs text-gray-500 mb-1 font-semibold">Examples:</p>
          <ul className="text-sm text-gray-700 mb-0 pl-4">
      ...
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              <th className="py-3 px-3 font-heading font-semibold">Temperature</th>
              <th className="py-3 px-3 font-heading font-semibold">Search intent</th>
              <th className="py-3 px-3 font-heading font-semibold">H7 should be</th>
              <th className="py-3 px-3 font-heading font-semibold">CTA tone</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Cold</td>
              <td className="py-3 px-3">Research, education</td>
              <td className="py-3 px-3">Problem/Pain (second variant)</td>
              <td className="py-3 px-3">&quot;Learn More&quot;, &quot;See How It Works&quot;</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Warm</td>
              <td className="py-3 px-3">Comparison, evaluation</td>
              <td className="py-3 px-3">USP or Value Prop (second variant)</td>
              <td className="py-3 px-3">&quot;Compare Plans&quot;, &quot;Book a Free Demo&quot;</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Hot</td>
              <td className="py-3 px-3">Purchase, booking</td>
              <td className="py-3 px-3">Social Proof or Risk Removal (second variant)</td>
              <td className="py-3 px-3">&quot;Get Started Today&quot;, &quot;Order Now&quot;</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 md:p-6 my-6">
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <strong>Add assets (formerly extensions)</strong>
      ...
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              <th className="py-3 px-3 font-heading font-semibold">Slot</th>
              <th className="py-3 px-3 font-heading font-semibold">Type</th>
              <th className="py-3 px-3 font-heading font-semibold">Example Headline</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">H1</td>
              <td className="py-3 px-3">Relevance Anchor</td>
              <td className="py-3 px-3">Premium Anti-Ageing Skincare UK</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">H2</td>
              <td className="py-3 px-3">Value Proposition</td>
              <td className="py-3 px-3">Dermatologist-Tested Formulas</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">H3</td>
              <td className="py-3 px-3">USP / Benefit</td>
              <td className="py-3 px-3">Visible Results in 28 Days</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">H4</td>
              <td className="py-3 px-3">Social Proof</td>
              <td className="py-3 px-3">Trusted by 15,000+ UK Customers</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">H5</td>
              <td className="py-3 px-3">Risk Removal</td>
              <td className="py-3 px-3">Free Next-Day Delivery Over £50</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">H6</td>
              <td className="py-3 px-3">Call-to-Action</td>
              <td className="py-3 px-3">Shop the Full Range Today</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">H7 (Cold)</td>
              <td className="py-3 px-3">Problem/Pain</td>
              <td className="py-3 px-3">Tired of Products That Don&apos;t Work?</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">H7 (Hot)</td>
              <td className="py-3 px-3">Urgency / Scarcity</td>
              <td className="py-3 px-3">Spring Sale — 20% Off This Week</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-2">Validate the user&apos;s pain and offer the solution. Include the keyword — Google bolds it.</p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-2">Build trust with a concrete proof point and close with a clear call to action.</p>
          <p className="text-xs bg-gray-100 rounded p-2 text-gray-700 mb-0">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-2">Use ONLY when there is a genuine deadline. False urgency destroys trust.</p>
          <p className="text-xs bg-gray-100 rounded p-2 text-gray-700 mb-0">
      ...
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              <th className="py-3 px-3 font-heading font-semibold">Quadrant</th>
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3">High CTR/Conv</td>
              <td className="py-3 px-3">Keep and learn from them</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              ...
              <td className="py-3 px-3">High CTR/Conv</td>
              <td className="py-3 px-3">Duplicate the angle in a new RSA</td>
            </tr>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3">High</td>
              <td className="py-3 px-3">Low CTR/Conv</td>
              <td className="py-3 px-3">Replace — consuming impressions without results</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              ...
              <td className="py-3 px-3">Low</td>
              <td className="py-3 px-3">Low CTR/Conv</td>
              <td className="py-3 px-3">Remove and write a new headline</td>
            </tr>
          </tbody>
        </table>
      </div>
