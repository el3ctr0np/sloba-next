  ...
  return (
    <>
      ...
      <p>
        ...
        RSA-ovima znači da se vaš oglas stapa sa svim ostalima.
      </p>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              Default mora biti dovoljno jak da stoji sam. Loše: {"{"}KeyWord:Naši Proizvodi{"}"}.
        ...
        <div className="border border-gray-200 rounded-xl overflow-hidden">
          ...
          <div className="bg-green-50 px-5 py-3">
            ...
            <p className="text-green-700 text-base mb-0">
              ...
              Pinovanje pretvara RSA u ETA - gubite se prednosti automatske kombinacije.
            </p>
          </div>
        </div>
      ...
      <div className="space-y-3 my-6">
        ...
        <details className="group border border-gray-200 rounded-lg">
          ...
          <div className="px-5 pb-4 text-base text-gray-600">
            ...
            varijacija iste poruke. Koristite angle-based slot distribution kao brif za AI:
