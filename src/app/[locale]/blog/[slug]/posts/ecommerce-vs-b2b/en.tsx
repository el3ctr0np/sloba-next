    ...
    <>
      ...
      <nav className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-8 shadow-card">
        ...
        <ol className="space-y-1.5 list-none pl-0 mb-0">
          <li><a href="#why-ecommerce-and-b2b-differ-in-google-ads" className="block py-1 text-base text-gray-700 hover:text-primary underline">Why eCommerce and B2B differ in Google Ads</a></li>
          <li><a href="#key-differences-comparison" className="block py-1 text-base text-gray-700 hover:text-primary underline">Key differences — comparison</a></li>
          <li><a href="#google-ads-strategy-for-ecommerce" className="block py-1 text-base text-gray-700 hover:text-primary underline">Google Ads strategy for eCommerce</a></li>
          <li><a href="#google-ads-strategy-for-b2b" className="block py-1 text-base text-gray-700 hover:text-primary underline">Google Ads strategy for B2B</a></li>
          <li><a href="#kpis-and-measuring-success" className="block py-1 text-base text-gray-700 hover:text-primary underline">KPIs and measuring success</a></li>
          <li><a href="#budget-and-expectations" className="block py-1 text-base text-gray-700 hover:text-primary underline">Budget and expectations</a></li>
          <li><a href="#most-common-mistakes-by-model" className="block py-1 text-base text-gray-700 hover:text-primary underline">Most common mistakes by model</a></li>
          ...
          <li><a href="#frequently-asked-questions-ecommerce-vs-b2b-google-ads" className="block py-1 text-base text-gray-700 hover:text-primary underline">Frequently asked questions — eCommerce vs B2B Google Ads</a></li>
        </ol>
      </nav>
        ...
        <table className="w-full border-collapse text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3">Minutes to days</td>
              <td className="py-3 px-3">Weeks to months</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Decision Makers</td>
              <td className="py-3 px-3">1 person</td>
              <td className="py-3 px-3">2-10 people</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Touchpoints</td>
              <td className="py-3 px-3">1-5 interactions</td>
              <td className="py-3 px-3">10-50+ interactions</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Primary conversion</td>
              <td className="py-3 px-3">Purchase (with value)</td>
              <td className="py-3 px-3">Lead (form, demo, call)</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Value</td>
              <td className="py-3 px-3">$20 - $800 (typical)</td>
              <td className="py-3 px-3">$2,000 - $200,000+</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Volume</td>
              <td className="py-3 px-3">High (hundreds of transactions)</td>
              <td className="py-3 px-3">Low (dozens of leads)</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Primary KPI</td>
              <td className="py-3 px-3">ROAS, Revenue, Conversion Rate</td>
              <td className="py-3 px-3">CPL, Lead Quality, SQL Rate</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Key campaigns</td>
        ...
        <table className="w-full border-collapse text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3">$3.00 - $15.00+</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
            ...
            <tr className="border-b border-gray-200 bg-gray-50/50">
              ...
              <td className="py-3 px-3">$15 - $80 (per purchase)</td>
              <td className="py-3 px-3">$80 - $800+ (per lead)</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Conversions monthly</td>
        ...
        <table className="w-full border-collapse text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3">$800 - $1,500/month</td>
              <td className="py-3 px-3">$2,500 - $4,000/month</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Recommended starting</td>
              <td className="py-3 px-3">$2,000 - $5,000/month</td>
              <td className="py-3 px-3">$5,000 - $8,000/month</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Time to results</td>
              <td className="py-3 px-3">2-4 weeks (first data)</td>
              <td className="py-3 px-3">1-3 months (quality leads)</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Scaling</td>
              <td className="py-3 px-3">Linear growth (2x budget = ~2x revenue)</td>
              <td className="py-3 px-3">Non-linear (higher budget ≠ 2x leads)</td>
            </tr>
          </tbody>
        </table>
      </div>
