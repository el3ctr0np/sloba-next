...
export default function GoogleShoppingVsSearchKampanjeSR() {
  return (
    <>
      ...
      <div className="bg-slate-900 text-white border border-gray-200 rounded-xl p-6 md:p-8 my-8 shadow-card">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
          <div className="text-center">
            ...
            <p className="text-xs text-slate-400 mt-1 mb-0">kampanje koje pokrivaju različite namere</p>
          </div>
          <div className="text-center">
      ...
      <p>
        Vodim Google Shopping za UK klijente duže od dve godine. Sa jednim od njih (UK skincare brend) kroz Shopping sam generisao šestocifren prihod (u funtama), uz POAS od 1,78x u kategoriji gde su marže tanke. Za istog klijenta paralelno vozim i Search. To lično iskustvo sa hibridom je okosnica ovog teksta - ne teorija, nego ono što stvarno radi na živim nalozima.
      </p>
      <p>
      ...
      <nav className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-8 shadow-card">
        ...
        <ul className="list-none pl-0 mb-0 space-y-0">
          ...
          <li><a href="#srbija-kontekst" className="block py-1 text-base text-gray-700 hover:text-primary underline">Srbija: šta radi danas, šta stiže u drugoj polovini 2026</a></li>
        ...
        <table className="w-full border-collapse text-left text-sm">
          ...
          <tbody>
            ...
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3">Skoro svaki ozbiljan eCommerce. Shopping pokriva &quot;znam šta hoću&quot;, Search pokriva istraživanje i brend - različite faze namere, pa jedno ne može da zameni drugo. Za isti UK nalog vozim oba tipa.</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <p>
        Za većinu eCommerce prodavnica sa fizičkim proizvodima, Shopping nosi najveći deo posla - industrijski izveštaji ga stavljaju na oko 80% eCommerce ad potrošnje, što je tržišni prosek, a ne preporučen split za tvoj nalog. Evo kada je jasan favorit.
      </p>
      ...
      <div className="space-y-4 my-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <p className="text-base text-gray-600 mb-0">
            Kao što sam gore objasnio - licitacija vezana za proizvod, plus slika i cena kao filter, obično znače niži CPC i manje potrošenog budžeta na promašene klikove. Za tanke marže (gde sam kod tog UK skincare brenda radio POAS 1,78x) ta efikasnost je razlika između profita i gubitka.
          </p>
        </div>
      </div>
      ...
      <p>
        Argument nije neki magičan procenat rasta - argument je pokrivenost. Ta dva tipa hvataju različite faze namere, pa jedno ne može da zameni drugo: Shopping odgovara na &quot;pokaži mi proizvod i cenu&quot;, a Search na istraživačke, comparison, brendirane i uslužne upite koji nikad ne uđu u product feed. Optmyzr studija na 24.702 PMax kampanje pokazala je da 82% oglašivača već vozi PMax uz Shopping ili Search, a grupa koja je pametno delila budžet imala je najjači povrat. Na UK nalogu koji sam gore pomenuo vozim oba tipa za istog klijenta upravo iz tog razloga.
      </p>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 md:p-6 my-6">
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <strong>Kreni od proizvoda, ne od procenta</strong>
      ...
      <p>
        ...
        </Link>. Ako se dvoumiš između Standard Shopping-a i PMax-a, detaljno sam to razložio u vodiču{" "}
      ...
      <h2 id="srbija-kontekst">Srbija: šta radi danas, šta stiže u drugoj polovini 2026</h2>
      <p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          <p className="text-xs uppercase tracking-wider text-gray-500 mb-2">Q3-Q4 2026 (očekivano)</p>
          <h3 className="text-base font-heading font-bold mt-0 mb-2">Shopping tek stiže u Srbiju</h3>
          <p className="text-base text-gray-600 mb-0">Google Shopping stiže u Srbiju u drugoj polovini 2026 (Q3 ili Q4) - tačan datum još nije potvrđen. Do tada Shopping kampanje jednostavno nisu dostupne za srpsko tržište. Ali priprema (Merchant Center nalog, product feed, atributi) može da počne već sada.</p>
        </div>
      </div>

      <p>
        Praktičan zaključak za srpski eCommerce: <strong>ne biraš između Shopping-a i Search-a - biraš redosled.</strong> Search pokrećeš danas i skupljaš podatke, prihod i istoriju naloga. Shopping pripremaš u pozadini da bi na dan lansiranja bio spreman umesto da tek tada kreneš od nule. Kada Shopping starta, prelaziš na hibrid koji sam opisao gore - i tada zaista voziš oba.
      </p>
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Za većinu eCommerce prodavnica sa fizičkim proizvodima Shopping nosi najveći deo prodaje, jer kupac vidi sliku i cenu pre klika. Industrijski izveštaji stavljaju Shopping na oko 80% eCommerce ad potrošnje, ali to je tržišni prosek, a ne preporučen split za tvoj nalog. Search hvata upite koje Shopping ne vidi - istraživačke i comparison upite, brendirane pretrage i usluge. Najbolji rezultat u 2026. daje hibrid: oba tipa vožena zajedno, uz budžetski split zasnovan na tvojim podacima."
                }
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Da, i to je standardan setup za ozbiljan eCommerce. Ta dva tipa nisu alternativa: Shopping i Search zauzimaju različite delove stranice rezultata, pa oba oglasa mogu da se prikažu za isti upit. Shopping pokriva kupca koji već zna šta hoće i poredi proizvode, a Search pokriva istraživačke, comparison, brendirane i uslužne upite koji nikad ne uđu u product feed. Budžet deliš po tome koja namera donosi profitabilne porudžbine, ne po fiksnom odnosu."
                }
              },
              {
                "@type": "Question",
      ...
      <div className="space-y-3 my-6">
        ...
        <details className="bg-white border-2 border-gray-200 rounded-xl group">
          ...
          <div className="px-5 pb-5 text-base text-gray-600 border-t border-gray-100 pt-3">
            Da, i to je standardan setup za ozbiljan eCommerce. Ta dva tipa nisu alternativa: Shopping i Search zauzimaju različite delove stranice rezultata, pa oba oglasa mogu da se prikažu za isti upit. Shopping pokriva kupca koji već zna šta hoće i poredi proizvode, a Search pokriva istraživačke, comparison, brendirane i uslužne upite koji nikad ne uđu u product feed. Budžet deliš po tome koja namera donosi profitabilne porudžbine, ne po fiksnom odnosu.
          </div>
        </details>
        ...
        <details className="bg-white border-2 border-gray-200 rounded-xl group">
          ...
          <div className="px-5 pb-5 text-base text-gray-600 border-t border-gray-100 pt-3">
            Google Shopping stiže u Srbiju u drugoj polovini 2026 (Q3 ili Q4), tačan datum još nije potvrđen. Do tada Shopping nije dostupan za srpsko tržište, ali Search radi već danas. Plan: pokreni Search odmah, a paralelno pripremaj Merchant Center i product feed da bi na dan lansiranja prešao na hibrid bez čekanja.
          </div>
        </details>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-6">
        ...
        <Link href={{ pathname: "/blog/[slug]", params: { slug: "performance-max-vs-standard-shopping-vodic" } }} className="block bg-white border-2 border-gray-200 rounded-xl p-4 hover:border-gray-900 transition-colors no-underline">
          ...
          <p className="text-xs text-gray-500 mb-0">Šta radi u 2026, gde koji pobeđuje i kako izgleda hibrid</p>
        </Link>
      </div>
    </>
  );
