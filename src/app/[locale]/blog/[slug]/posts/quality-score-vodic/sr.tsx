    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-6">
        ...
        <Link href={{ pathname: "/blog/[slug]", params: { slug: "google-search-kampanje-vodic" } }} className="block bg-white border-2 border-gray-200 rounded-xl p-4 hover:border-gray-900 transition-colors no-underline">
          <p className="font-heading font-semibold text-gray-900 mb-1 text-sm">Search kampanje vodič</p>
          <p className="text-xs text-gray-500 mb-0">Kompletan pristup Search kampanjama, temelj za svaki nalog</p>
        </Link>
