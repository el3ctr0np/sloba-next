    ...
    <>
      ...
      <nav className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-8 shadow-card">
        ...
        <ol className="space-y-1.5 list-none pl-0 mb-0">
          ...
          <li><a href="#faq" className="block py-1 text-base text-gray-700 hover:text-primary underline">Najčešća pitanja o ROAS-u</a></li>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              ...
              <th className="py-3 px-3 font-heading font-semibold">Potrošnja</th>
          ...
          <tbody>
            ...
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3"><span className="inline-block bg-yellow-100 text-yellow-800 text-xs font-semibold px-2 py-0.5 rounded">Solidno</span></td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
            ...
            <tr className="border-b border-gray-200">
              ...
              <td className="py-3 px-3"><span className="inline-block bg-green-100 text-green-800 text-xs font-semibold px-2 py-0.5 rounded">Izuzetno</span></td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="overflow-x-auto my-6">
        <table className="w-full border-collapse text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">eCommerce — Moda/Odeća</td>
              <td className="py-3 px-3 text-green-700 font-semibold">4.0×</td>
              <td className="py-3 px-3">Marže 40–60%, brand dependency</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">eCommerce — Kozmetika</td>
              <td className="py-3 px-3 text-green-700 font-semibold">3.5×</td>
              <td className="py-3 px-3">Visok LTV, repeat orders</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">eCommerce — Elektronika</td>
              <td className="py-3 px-3 text-green-700 font-semibold">5.0×</td>
              <td className="py-3 px-3">Niske marže (5–15%), traži visok ROAS</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">eCommerce — Dom i bašta</td>
              <td className="py-3 px-3 text-green-700 font-semibold">3.8×</td>
              <td className="py-3 px-3">Solidne marže, sezonski</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">eCommerce — Hrana / Pića</td>
              <td className="py-3 px-3 text-green-700 font-semibold">4.5×</td>
              <td className="py-3 px-3">Subscription povećava LTV</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">SaaS / B2B</td>
              <td className="py-3 px-3 text-green-700 font-semibold">3.0×</td>
              <td className="py-3 px-3">LTV-based (računa se na 12-mesečni prihod)</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-3 px-3 font-medium">Lead Gen (lokalne usluge)</td>
              <td className="py-3 px-3 text-green-700 font-semibold">2.5×</td>
              <td className="py-3 px-3">Prati CPA umesto ROAS ako nema direktne prodaje</td>
            </tr>
            <tr className="border-b border-gray-200 bg-gray-50/50">
              <td className="py-3 px-3 font-medium">Luksuz / premium</td>
              <td className="py-3 px-3 text-green-700 font-semibold">6.0×</td>
              <td className="py-3 px-3">Visoke marže, manji volumen, selektivno targetiranje</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Pauzirajte ad grupe/ključne reči sa stabilno niskim ROAS-om (ispod break-even). Budžet ide ka winner-ima.</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Viša konverzija na landing page-u → više prihoda na isti broj klikova → viši ROAS. Testirajte brzinu, CTA, social proof.</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Svaki klik od irelevantne pretrage je spend bez prihoda. Mesečni Search Terms pregled + agresivne negative liste održava ROAS.</p>
        </div>
      </div>
