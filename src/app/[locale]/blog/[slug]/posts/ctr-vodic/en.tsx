    ...
    <>
      ...
      <nav className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 my-8 shadow-card">
        ...
        <ol className="space-y-1.5 list-none pl-0 mb-0">
          ...
          <li><a href="#when-low-ctr-is-ok" className="block py-1 text-base text-gray-700 hover:text-primary underline">When low CTR is actually OK</a></li>
          <li><a href="#myth-high-ctr" className="block py-1 text-base text-gray-700 hover:text-primary underline">MYTH: "High CTR = successful campaign"</a></li>
          <li><a href="#faq" className="block py-1 text-base text-gray-700 hover:text-primary underline">Frequently asked questions about CTR</a></li>
        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead>
            <tr className="border-b-2 border-gray-900 bg-gray-50">
              ...
              <th className="py-3 px-3 font-heading font-semibold">Clicks</th>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Lower CTR is normal as these are awareness ads. Remarketing Display can be higher.</p>
        </div>
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Skippable ads have lower CTR. Non-skippable and bumper ads are measured differently.</p>
        </div>
      </div>
      ...
      <div className="space-y-4 my-6">
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Solution:</strong> Add specific numbers (&quot;Repairs from $50&quot;), questions (&quot;Looking for a plumber?&quot;) and urgency (&quot;Available today&quot;).</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Solution:</strong> Use narrower match types (phrase, exact) or if using broad — add an extensive negative keyword list and regularly review the Search Terms Report.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Solution:</strong> Create a separate branded campaign. Add your brand as a negative keyword in non-branded campaigns. This gives you accurate insights into CTR for both categories.</p>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div className="bg-green-50 border-l-4 border-green-500 rounded-r-lg p-3">
            <p className="text-base text-green-800 mb-0"><strong>Solution:</strong> Have a minimum of 2 RSA ads per Ad Group. Test different descriptions, sitelinks, or completely different approaches. It depends on the client and industry.</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 my-6">
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-0">First check if the queries are relevant. If you&apos;re getting clicks for irrelevant searches, CTR will be low because the ad isn&apos;t meant for those people. Add negative keywords.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-0">Review headlines and descriptions. Are they generic? Do they have numbers, questions, urgency? Do they communicate WHY to buy? Rewrite ads with clear benefits.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border border-gray-200 rounded-xl p-5">
          ...
          <div>
            ...
            <p className="text-base text-gray-600 mb-0">Look at the competition. If your Impression Share dropped and competitors added new ads, you might need a more aggressive approach or better bidding.</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">&quot;Repairs from $50&quot; or &quot;Delivery in 30 minutes&quot; attract more attention than generic headlines.</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">&quot;Looking for a plumber?&quot; or &quot;Need an auto mechanic?&quot; directly address the user&apos;s need.</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">&quot;Available today&quot;, &quot;24/7 service&quot;, &quot;We arrive in 30 min&quot; — urgency drives action.</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">Instead of generic links, link to specific sections of the landing page. This helps users get to the desired information faster.</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-card">
          ...
          <p className="text-base text-gray-600 mb-0">For some industries, pain points work (&quot;No hidden fees&quot;), for others benefits (&quot;Free shipping&quot;). Test both approaches.</p>
        </div>
